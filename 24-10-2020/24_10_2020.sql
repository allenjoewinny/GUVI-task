...
CREATE TABLE user_login_details(id int, email_id varchar(20));
...
INSERT INTO user_login_details VALUES(1,'1@gmail.com');
INSERT INTO user_login_details VALUES(2,'2@gmail.com');
INSERT INTO user_login_details VALUES(3,'3@yahoo.com');
INSERT INTO user_login_details VALUES(4,'4@gmail.com');
INSERT INTO user_login_details VALUES(5,'5@yahoo.com');
...
select id , email_id from user_login_details where email_id LIKE "%gmail%";
...
select user_name, active_or_not,email_id from (user_profile u inner join Profile_status p on u.id =p.id )inner join  user_login_details l on l.id = p.id;
